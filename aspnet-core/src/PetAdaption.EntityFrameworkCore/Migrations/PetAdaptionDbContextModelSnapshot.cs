...
namespace PetAdaption.Migrations
{
    ...
    partial class PetAdaptionDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetAdaption.Domain.Pets_Module.Pet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PetAdaption.Domain.Pets_Module.PetCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PetAdaption.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PetAdaption.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PetAdaption.Domain.Pets_Module.Pet", b =>
                {
                    b.HasOne("PetAdaption.Domain.Pets_Module.PetCategory", "Category")
                        .WithMany()
