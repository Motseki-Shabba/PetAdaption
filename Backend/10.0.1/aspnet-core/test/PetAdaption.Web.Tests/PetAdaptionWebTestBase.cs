...
public abstract class PetAdaptionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PetAdaptionWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PetAdaptionWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PetAdaptionDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PetAdaptionDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PetAdaptionDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PetAdaptionDbContext, Task<T>> func)
    {
        T result;
